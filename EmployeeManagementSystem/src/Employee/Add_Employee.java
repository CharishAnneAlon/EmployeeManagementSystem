...
class Add_Employee implements ActionListener{
    ...
    JFrame f;
    JLabel id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,lab,lab1;
    ...
    Add_Employee(){
        ...
        id4= new JLabel("Performance Reviews");  
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String performance = t4.getText();
        String address = t5.getText();
        String jobexp = t6.getText();
        String emailid = t7.getText();
        String education = t8.getText();
        String jobpost = t9.getText();
        String mobileno = t10.getText();
        String employeeid = t11.getText();
        
        
        if(e.getSource()== b){
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/employee", "root", "charish");
            String query = "INSERT INTO addemployee (name, fathersname, age, performancereview, address, jobexp, emailid, education, jobpost, mobileno, employeeid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement preparedStatement = conn.prepareStatement(query);
            preparedStatement.setString(1, name);
            preparedStatement.setString(2, fname);
            preparedStatement.setString(3, age);
            preparedStatement.setString(4, performance);
            preparedStatement.setString(5, address);
            preparedStatement.setString(6, jobexp);
            preparedStatement.setString(7, emailid);
            preparedStatement.setString(8, education);
            preparedStatement.setString(9, jobpost);
